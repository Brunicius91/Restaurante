...
-- Criando a tabela info_produtos
...
-- Inserindo registros na tabela info_produtos
...
-- Atualizando um resgistro  da tabela funcionarios
UPDATE funcionarios
SET cargo = 'Garçonete', salario = 2700
where cpf = '444.555.666-77';

-- Atualizando um resgistro da tabela pedidos
UPDATE pedidos
SET status_pedido = 'Concluído'
WHERE data_pedido < '2024-07-06';

-- Deletando um registro da tabela funcionarios
